...
const metadata = {
  navigation: {
    // Hide specific navigation tabs by setting visibility to 'hidden'
    ...
    groups: { visibility: 'hidden' },
    allUsers: { visibility: 'hidden' },
    roles: { visibility: 'hidden' },
    security: { visibility: 'hidden' },
    sso: { visibility: 'hidden' },
    provisioning: { visibility: 'hidden' },
    audits: { visibility: 'hidden' },
    webhooks: { visibility: 'hidden' },
    apiTokens: { visibility: 'hidden' },
    personalApiTokens: { visibility: 'hidden' },
    subscriptions: { visibility: 'hidden' },
    allAccounts: { visibility: 'hidden' }
  }
};
